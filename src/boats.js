...
//
// Each class now has 5 boats instead of 3: the two new ones per class are
// interpolated between the neighbouring boats' price/speed/goldMultiplier/
// upgradeBase (geometric mean for the money figures, linear for speed and
// the multiplier), so the class's cheapest and priciest boat are unchanged
// from before — this only adds granularity, it doesn't re-widen a class
// and re-break the pacing that's already been tuned and simulated.
//
...
export const BOATS = [
  ...
  { id: '420', classId: 'derive', name: '420 Sport', price: 1200, currency: 'gold', baseSpeed: 11.5, goldMultiplier: 1.075, upgradeBase: 85 },
  ...
  { id: 'mini-pogo3', classId: 'mini650', name: 'Mini Série Pogo 3', price: 9200, currency: 'gold', baseSpeed: 11.5, goldMultiplier: 1.175, upgradeBase: 370 },
  ...
  { id: 'mini-proto-foiler', classId: 'mini650', name: 'Mini Proto Foiler', price: 20500, currency: 'gold', baseSpeed: 17, goldMultiplier: 1.225, upgradeBase: 790 },
  ...
  { id: 'halfton-sport', classId: 'halfton', name: 'Half-Ton Sport', price: 44000, currency: 'gold', baseSpeed: 10, goldMultiplier: 1.325, upgradeBase: 1500 },
  ...
  { id: 'halfton-course', classId: 'halfton', name: 'Half-Ton Course', price: 92000, currency: 'gold', baseSpeed: 12, goldMultiplier: 1.375, upgradeBase: 3000 },
  ...
  { id: 'class40-sport', classId: 'class40', name: 'Class40 Sport', price: 505000, currency: 'gold', baseSpeed: 18, goldMultiplier: 1.475, upgradeBase: 15300 },
  ...
  { id: 'class40-elite', classId: 'class40', name: 'Class40 Elite', price: 965000, currency: 'gold', baseSpeed: 22.5, goldMultiplier: 1.525, upgradeBase: 28700 },
  ...
  { id: 'imoca-newgen', classId: 'imoca', name: 'IMOCA Nouvelle Génération', price: 3700000, currency: 'gold', baseSpeed: 28.5, goldMultiplier: 1.64, upgradeBase: 111000 },
  ...
  { id: 'imoca-vendee-elite', classId: 'imoca', name: 'IMOCA Vendée Élite', price: 6900000, currency: 'gold', baseSpeed: 33, goldMultiplier: 1.715, upgradeBase: 201000 },
  ...
  { id: 'ocean50-sport', classId: 'ocean50', name: 'Ocean Fifty Sport', price: 18700000, currency: 'gold', baseSpeed: 31, goldMultiplier: 1.9, upgradeBase: 517000 },
  ...
  { id: 'ocean50-course', classId: 'ocean50', name: 'Ocean Fifty Course', price: 37400000, currency: 'gold', baseSpeed: 37, goldMultiplier: 2.0, upgradeBase: 950000 },
  ...
  { id: 'ac75-contender', classId: 'ac75', name: 'AC75 Contender', price: 69600000, currency: 'gold', baseSpeed: 45, goldMultiplier: 2.225, upgradeBase: 3050000 },
  ...
  { id: 'ac75-racespec', classId: 'ac75', name: 'AC75 Race Spec', price: 111000000, currency: 'gold', baseSpeed: 51.5, goldMultiplier: 2.375, upgradeBase: 5300000 },
  ...
  { id: 'f50-race', classId: 'f50', name: 'F50 Race', price: 190000000, currency: 'gold', baseSpeed: 52.5, goldMultiplier: 2.7, upgradeBase: 12000000 },
  { id: 'f50-gp', classId: 'f50', name: 'F50 Grand Prix', price: 110, currency: 'gems', baseSpeed: 55, goldMultiplier: 2.8, upgradeBase: 15000000 },
  { id: 'f50-championship', classId: 'f50', name: 'F50 Championship', price: 145, currency: 'gems', baseSpeed: 56.5, goldMultiplier: 2.9, upgradeBase: 20000000 },
  ...
  { id: 'ultim-challenger', classId: 'ultim', name: 'Ultim Challenger', price: 350000000, currency: 'gold', baseSpeed: 47, goldMultiplier: 3.45, upgradeBase: 54000000 },
  ...
  { id: 'ultim-legende', classId: 'ultim', name: 'Ultim Légende', price: 300, currency: 'gems', baseSpeed: 52, goldMultiplier: 3.8, upgradeBase: 95000000 },
